...
2. Answer **No** to “Do you already have a DOI for this upload?”
3. Use **Get a DOI now!** to reserve the DOI before final PDF rendering.
4. Insert the reserved DOI into the archival PDF.
...
Do not delete the Zenodo draft after reserving its DOI unless intentionally abandoning that DOI.
...
**Files:** one deterministic archive plus a human-readable manifest
...
Once both DOIs are reserved:

- Record A (paper) should identify Record B as **isSupplementedBy**.
- Record B (measurement package) should identify Record A as **isSupplementTo**.
...
- the PDF must embed the reserved paper DOI;
