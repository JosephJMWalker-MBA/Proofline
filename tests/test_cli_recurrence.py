...
from proofline import Ingestor, SegmentRecurrenceClusterer
from proofline.segments import SegmentIndex, SegmentationPlan, SegmentationRule


def test_recurrence_clusterer_is_exported_from_public_api() -> None:
    assert SegmentRecurrenceClusterer.__module__ == "proofline.recurrence"
