...
def test_t21_april27_low_quality_ocr_receipt_is_pre_reading_and_pinned():
    ...
    assert receipt["silver_summary"] == {
        ...
        "preferred_method_counts": {
            "pymupdf_native_text": 7,
            "pymupdf_tesseract_ocr": 41,
        },
...
def test_t21_april27_low_quality_ocr_receipt_freezes_all_page_text_hashes_without_prose():
    ...
    assert _sha256_json(page_hashes) == "6e8a2ce042f80bd8127e2595f5efe260823c83c929154ba06cc6e665f20b9677"
    assert receipt["page_text_hashes_signature_sha256"] == "6e8a2ce042f80bd8127e2595f5efe260823c83c929154ba06cc6e665f20b9677"
